    ...
    <div className="flex flex-col gap-4 min-w-[320px] w-full max-w-[400px]">
      <div className="flex items-center justify-between px-2">
        <div className="flex items-center gap-2">
          ...
          <span className="flex items-center justify-center w-6 h-6 text-xs font-bold bg-apple-border/30 text-apple-gray rounded-full">
            {tasks.length}
          </span>
        </div>
      </div>
      ...
      <div
        ...
        className={`flex-1 flex flex-col gap-3 p-2 rounded-apple-lg transition-colors duration-200 min-h-[500px] ${
          isOver ? 'bg-apple-border/20' : 'bg-transparent'
        }`}
      >
